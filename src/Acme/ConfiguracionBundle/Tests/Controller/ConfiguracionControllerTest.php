...
namespace Acme\ConfiguracionBundle\Tests\Controller;
...
class ConfiguracionControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'acme_configuracionbundle_configuracion[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'acme_configuracionbundle_configuracion[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
